...
quadrado(ctx2,1, 'gray', 'gray', 0, 230, 300, 70)
linha(ctx2,1, '#458efc', '#458efc', 0, 230, 0, 300, 110, 300, 110, 265, 35, 265, 35, 230)
arco(ctx2,1, '458efc', '458efc', 0, 230, 35, 1,0)
arco(ctx2,1, '458efc', '458efc', 110, 300, 35, 1,0)
quadrado(ctx2,1, 'saddlebrown', 'saddlebrown', 36, 195, 15, 35)
arco(ctx2,1, 'green', 'green', 43.5, 175, 22.5, 0, 2)
quadrado(ctx2,1, 'saddlebrown', 'saddlebrown', 110, 150, 80, 80)
linha(ctx2,1, '#f5694d', '#f5694d', 110, 150, 190, 150, 150, 110)
quadrado(ctx2,1, '#624423', '#624423', 141.25, 190, 17.5, 40)
quadrado(ctx2,1, '#47bdfd', '#47bdfd', 119, 168, 20, 20)
quadrado(ctx2,1, '#47bdfd', '#47bdfd', 160, 168, 20, 20)
quadrado(ctx2,1, 'saddlebrown', 'saddlebrown', 259, 230, 15, 35)
arco(ctx2,1, 'green', 'green', 266.5, 212.5, 22.5, 0, 2)
arco(ctx2,1, 'yellow', 'yellow', 225, 75, 34, 0, 2)
